...
contract("TestUniswapFlashSwap", (accounts) => {
    ...
    beforeEach(async () => {
        ...
        assert(bal.gte(FUND_AMOUNT), "balance < FUND")//hàm gte so sánh
        //check nếu số dư USDC của WHALE >= FUND_AMOUNT thì transfer nó sang địa chỉ contract flash swap
        //vì thực chất ta muốn flashswap vay thử 1 lượng BORROW_AMOUNT nhưng thực tế cuối contract ta phải trả 
        //lại 1 lượng lớn hơn là BORROW_AMOUNT + 0.3%BORROW_AMOUNT là fee đó nên tốt nhất cứ truyền hẳn cho
        //contract 1 lượng USDC là FUND_AMOUNT gấp đôi luôn để thực hiện ok. Cần unlock USDC_WHALE
