...
//muốn lấy bất cứ contract nào thì require thôi
...
contract("TestUniswap", (accounts) => {
    ...
    let tokenA;
    let tokenB;
    //thay vì gửi từ DAI_WHALE vào accounts[0] thì nếu DAI_WHALE nó éo có ETH thì k gửi được => rất ez ta gửi từ
    //accounts[0] vào DAI_WHALE 1 lượng ETH từ trước để trả fee r mới thực hiện tiếp là đc
    beforeEach(async () => {
    ...
    //ta có thể thấy lượng amount ta nhận ra nó nhỏ hơn amount lúc đầu thực chất là sai vì JS có cơ chế
    //làm tròn số. Thực ra là bằng nhau cả đấy
